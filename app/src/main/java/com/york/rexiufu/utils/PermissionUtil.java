    ...
    private void showSystemPermissionsSettingDialog(final Activity context) {
        ...
        if (mPermissionDialog == null) {
            mPermissionDialog = new AlertDialog.Builder(context)
                    .setMessage(context.getString(R.string.text_no_permission))
                    .setPositiveButton(context.getString(R.string.text_no_permission_setting), new DialogInterface.OnClickListener() {
                        @Override
